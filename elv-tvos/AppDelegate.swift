...
Abstract:
Delegate methods called on app startup that create the JavaScript bridge and contain the initial server information.
*/
...
class AppDelegate: UIResponder, UIApplicationDelegate, TVApplicationControllerDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        // Create the TVApplicationControllerContext for this application and set the properties that
        // will be passed to the `App.onLaunch` function in JavaScript.
        let appControllerContext = TVApplicationControllerContext()
        
        // The JavaScript URL is used to create the JavaScript context for your TVMLKit application.
        // Although it is possible to separate your JavaScript into separate files, to help reduce the launch time of your application
        // we recommend creating minified and compressed version of this resource.
        // This will allow for the resource to be retrieved and UI presented to the user quickly.
